...
__git_eread () { 	local f="$1"; 	shift; 	test -r "$f" && read "$@" <"$f"; }
...
cd
echo $HOME
git config --global uer.name "Sahnawaz Khan"
git config --global uer.email "sahnawaz@hotmail.com"
